...
aggregator.py:    def _compute_blame_primitives(
...
db.py:    def _add_column_if_missing(
...
electricity_cost.py:    def compute_blame(
...
idle_baseline.py:    def _store_baseline(self, cpu_idle_w: float, gpu_idle_w: float) -> None:  # Store baseline reading in database.
idle_baseline.py:    def get_baseline_average(self) -> Optional[dict]:  # Get the average of all stored baseline readings.
idle_baseline.py:    def get_recent_baseline(self, count: int = 10) -> Optional[dict]:  # Get average of most recent baseline readings.
