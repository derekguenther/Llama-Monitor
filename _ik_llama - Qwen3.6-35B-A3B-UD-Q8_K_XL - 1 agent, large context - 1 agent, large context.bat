...
start /affinity FFFF /b /wait "" "C:\Users\ClaudeCode\Documents\windows_ik_llama.cpp\vendor\ik_llama.cpp\build\bin\Release\llama-server.exe" -m "D:\AI\LLMs\General Use\Qwen3.6-35B-A3B-UD-Q8_K_XL.gguf" --metrics --alias qwen3-coder-next --port 8000 --jinja --ctx-size 262144 --parallel 1 --cache-type-k bf16 --cache-type-v bf16 --flash-attn on --no-mmap --mlock --n-gpu-layers 999 --cpu-moe --temp 0.6 --top-p 0.95 --min-p 0.01 --top-k 30 --repeat-penalty 1.0 --threads 8 --threads-batch 16 --batch-size 4096 --ubatch-size 4096
