...
def index() -> str:
    ...
    context_limit = getattr(config, "server.context_limit", 4096)  # Default 4096
...
<head>
    ...
    <style>
        * {
        ...
        /* Slot Progress and Context Remaining Bar Graphs */
        ...
        .slot-bar-fill.progress {
            background: linear-gradient(90deg, #00d9ff, #00ff88);
        }

        .slot-bar-fill.context {
