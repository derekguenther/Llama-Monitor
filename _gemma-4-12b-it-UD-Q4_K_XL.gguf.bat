...
start /affinity FFFF /b /wait "" "C:\Users\ClaudeCode\Documents\windows_llama.cpp - b9553 for Gemma 4 coding\vendor\llama.cpp\build\bin\Release\llama-server.exe" -m "D:\AI\LLMs\General Use\gemma-4-12b-it-UD-Q4_K_XL.gguf" --jinja --metrics --alias gemma4coding --host 0.0.0.0 --port 8000 --ctx-size 65536 --parallel 1 --cache-type-k bf16 --cache-type-v bf16 --n-gpu-layers 99 --n-gpu-layers-draft 99 --cache-reuse 21504 --flash-attn on --no-mmap --mlock --fit off --cpu-moe --temp 1.0 --top-p 0.95 --min-p 0.01 --top-nsigma 3 --top-k 64 --repeat-penalty 1.0 --threads 8 --threads-batch 16 --cpu-range 0-15 --cpu-strict 1 --batch-size 4096 --ubatch-size 4096 --spec-type draft-mtp --spec-draft-p-min 0.75 --spec-draft-n-max 4 --model-draft "D:\AI\LLMs\Coding\Gemma 4 coder\gemma-4-12B-it-MTP-Q8_0.gguf"
