...
class Aggregator:
    ...
    def _extract_system_metrics(self, system_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "gpu_memory_used": safe_float(gpu.get("memory_used")),
            "gpu_memory_total": safe_float(gpu.get("memory_total")),
            ...
            "memory_used": safe_float(memory.get("used")),
            "memory_total": safe_float(memory.get("total")),
